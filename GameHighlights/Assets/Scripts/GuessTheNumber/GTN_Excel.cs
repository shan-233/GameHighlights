...
public class GTN_Excel : MonoBehaviour
{
    public void click()
    {
    ...
    public static void WriteExcel(string excelName, string sheetName)
    {
        ...
        using (ExcelPackage package = new ExcelPackage(newFile))
        {
            ...
            if (flag == 0)
            {
                ...
                worksheet.Cells[row_count + 1, 4].Value = "成績";
                row_count = 1;
                worksheet.Cells[row_count + 1, 1].Value = global.gtn_name;
                worksheet.Cells[row_count + 1, 2].Value = global.gtn_total_count;
                worksheet.Cells[row_count + 1, 3].Value = global.gtn_time;
                worksheet.Cells[row_count + 1, 4].Value = global.gtn_level;
            }
            else
            {
